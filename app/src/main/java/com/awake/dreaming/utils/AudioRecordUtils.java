...
public class AudioRecordUtils extends SQLiteOpenHelper{
    ...
    public AudioRecordUtils(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
